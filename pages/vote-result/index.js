...
const VoteResult = () => {
  ...
  return (
    <div>
      ...
      <div className="flex bg-white rounded-lg border border-gray-dark p-1 w-[45rem] m-auto mt-2">
      ...
      <div className="flex bg-gray rounded-full w-[45rem] m-auto mt-4 text-xl font-semibold">
        <button
          type="submit"
      ...
      <div className="grid grid-cols-1 gap-4 m-auto mt-4 w-[45rem] h-[36rem] overflow-auto">
        {resultData.map((data, index) => {
          return (
            <div className="flex bg-white rounded-lg border border-gray-dark">
              ...
              <img
                className="flex-none object-cover w-44 h-44"
              ...
              <div className="flex-auto m-4">
                ...
                <div className="text-md my-2 opacity-80">

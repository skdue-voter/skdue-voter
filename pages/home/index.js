    ...
    <div>
      ...
      <div className="grid grid-cols-5 gap-4 my-5 w-[600px] xl:w-[800px] m-auto">
        ...
        <div className="bg-white rounded-lg border border-gray-dark col-span-3">
          <h1 className="text-xl xl:text-3xl font-semibold p-2 items-center">Donald Trump's Election</h1>
          <img className="object-cover w-full" src="trump.jpg" alt="donald trump image"></img>
          ...
          <div className="grid grid-cols-4 grid-rows-2 gap-1.5 px-2 text-md xl:text-lg font-medium">
            ...
            <button type="submit" onClick={() => {window.location.assign("/candidate")}}
              className="bg-gray py-0.5 font-medium rounded-md hover:brightness-90">Candidate</button>
          </div>
          <hr className="my-2 h-px bg-gray border-0" />
